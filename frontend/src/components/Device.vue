<template>
   <q-card>
        <q-card-section>
            ...
            <q-badge v-if="device.status == true" color="positive">Online</q-badge>
            <q-badge v-if="device.status == null" color="info">Unkown</q-badge>
            <q-badge v-if="device.status == false" color="negative">Offline</q-badge> 
        </q-card-section> 
        <q-card-actions align="right">
            <q-btn round dense color="negative" @click="confirmDeleteDevice = true">
            ...
            <q-dialog v-model="confirmDeleteDevice">
                <q-card>
                    <q-card-section class="row items-center">
                        ...
                        <br>
                        <div class="text-p">Are you sure you want to delete this device?</div>
                    </q-card-section>
                    <q-card-actions align="center">
                        <q-btn label="Cancel" color="primary" v-close-popup></q-btn>
                        <q-btn label="Confirm" color="negative" @click="deleteDevice"></q-btn>
                    </q-card-actions>
                </q-card>
            </q-dialog>
        </q-card-actions>
